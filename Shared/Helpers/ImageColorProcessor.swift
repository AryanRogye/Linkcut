...
public final class ImageColorProcessor {
    ...
    public static func getDominantColor(from image: Image) -> Color? {
        #if os(macOS)
     ...
     */
    public static func getDominantColor(from cgImage: CGImage) -> Color? {
...
extension ImageColorProcessor {
    internal static func adjustBrightness(
        red: CGFloat,
        green: CGFloat,
        blue: CGFloat,
        alpha: CGFloat
